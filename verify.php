            ...
            <?php if ($cert): ?>
                ...
                <div class="cert-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value" style="font-family: monospace; color: var(--primary);"><?= htmlspecialchars($cert['verification_code']) ?></span>
                    </div>
                </div>
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                    <div class="verify-icon" style="background: var(--primary-light); color: var(--primary);">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                    </div>
                ...
                <form action="verify.php" method="GET">
                    <div class="form-group text-left" style="margin-bottom: 16px;">
                        <input type="text" name="code" class="form-control" placeholder="Ex: b3f8x2ac412" value="<?= htmlspecialchars($code) ?>" required style="text-align: center; font-size: 1.1rem; letter-spacing: 1px; font-family: monospace;">
                    </div>
                    <button type="submit" class="btn btn-primary w-full" style="padding: 14px; font-size: 1rem;">Vérifier</button>
                </form>
