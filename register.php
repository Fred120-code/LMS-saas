    ...
    <div class="login-box" style="max-width: 500px;">
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="email" id="email" name="email" required placeholder="vous@exemple.com"
      ...
      <div class="text-center mt-2" style="font-size:.85rem;">
        Déjà inscrit ? <a href="index.php"
          style="color:var(--primary-light);font-weight:600;text-decoration:underline;">Se connecter</a>
      </div>
    </div>
  </div>
</body>
