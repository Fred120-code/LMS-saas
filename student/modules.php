    ...
    <div class="main-content">
      ...
      <main class="page-body">
        <div
          ...
          <input class="form-control" type="search" id="search-modules" placeholder="Rechercher un module…"
              ...
              <div class="module-card">
                ...
                <div class="module-card-body">
                  <p class="module-card-meta" style="min-height: 50px;">
                    <?= htmlspecialchars(substr($m['description'], 0, 120)) ?>
                    <?= strlen($m['description']) > 120 ? '...' : '' ?>
                  </p>

                  <div
                    style="font-size:.78rem; color:var(--text-muted); margin-bottom:4px; display:flex; justify-content:space-between;">
                  ...
                  <div class="module-card-progress" style="margin-bottom: 20px;">
                    <div style="display:flex; align-items:center; gap:8px;">
                      ...
                      <span class="pct"
                        style="font-weight:600; font-size:.8rem; min-width:32px;"><?= round($m['pourcentage']) ?>%</span>
                    </div>
                  </div>

                  <a href="courses.php?module_id=<?= $m['id'] ?>" class="btn btn-primary w-full"
