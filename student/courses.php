      ...
      <main class="page-body">
        ...
        <div class="card mb-3" style="background:var(--primary); color: #fff;">
          <div class="card-body" style="padding: 32px;">
            <h1 style="color:#fff; margin-bottom:12px; font-family:'Playfair Display', serif;">
              <?= htmlspecialchars($module['titre']) ?></h1>
            ...
            <div style="display:flex; align-items:center; gap:16px; flex-wrap:wrap;">
              ...
              <span style="font-size:.85rem; color:var(--accent); font-weight:500;">(<?= $completed_lessons ?> /
                <?= $total_lessons ?> leçons)</span>
            </div>
          </div>
        </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div>
                    ...
                    <span class="text-muted" style="font-size:.8rem;">Enseigné par :
                      <strong><?= htmlspecialchars($c['prenom'] . ' ' . $c['nom']) ?></strong></span>
                  </div>
                </div>
                <div class="card-body">
                  ...
                  <?php if (empty($c['lessons'])): ?>
                    <p class="text-muted" style="font-size:.85rem; font-style:italic;">Aucune leçon disponible pour ce cours.
                    </p>
                  <?php else: ?>
