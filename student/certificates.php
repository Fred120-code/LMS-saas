...
if (isset($_GET['print_id'])) {
    ...
    <head>
      ...
      <style>
        :root {
            --cert-bg: #ffffff;
            --cert-primary: #0A192F; /* Deep navy blue */
            --cert-gold: #C5A059; /* Elegant gold */
            --cert-text: #333333;
            --cert-muted: #666666;
            --cert-light: #F8F9FA;
        }
        * {
        ...
        .cert-logo::before, .cert-logo::after {
            content: '';
            display: block;
            width: 40px;
            height: 1px;
        ...
        @media print {
            ...
            .cert-wrapper {
                ...
                max-width: none;
                aspect-ratio: auto;
                padding: 12mm; /* Give print margins */
            }
            .cert-seal {
                box-shadow: none;
            }
        ...
        @media (max-width: 900px) {
            ...
            .cert-title { font-size: 32px; letter-spacing: 4px; }
