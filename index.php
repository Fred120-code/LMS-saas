    ...
    <div class="login-box">
      ...
      <form method="POST" action="">
        <div class="form-group">
          ...
          <input class="form-control" type="email" id="email" name="email" placeholder="vous@exemple.com" required
      ...
      <div class="text-center mt-2" style="font-size:.85rem;">
        Pas encore de compte ? <a href="register.php"
          style="color:var(--primary-light);font-weight:600;text-decoration:underline;">S'inscrire</a>
      </div>
