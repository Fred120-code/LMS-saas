              ...
              <table>
                ...
                <tbody>
                  <?php if (empty($courses)): ?>
                    <tr>
                      <td colspan="4" class="text-center text-muted" style="padding:24px;">Aucun cours créé pour le
                        moment.</td>
                    </tr>
                  <?php else: ?>
                    <?php foreach ($courses as $c): ?>
                      <tr>
                        ...
                        <td class="text-muted" style="font-size:.8rem;"><?= date('d/m/Y', strtotime($c['created_at'])) ?>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php endif; ?>
              ...
              <table>
                ...
                <tbody>
                  <?php if (empty($recentResults)): ?>
                    <tr>
                      <td colspan="4" class="text-center text-muted" style="padding:24px;">Aucun élève n'a encore passé
                        d'évaluation.</td>
                    </tr>
                  <?php else: ?>
